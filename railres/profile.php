...
<style>
        body {
            background-image: url('pexels-felix-mittermeier-2832046.jpg');
...
<body>
	...
	<div class="wrap">
		...
		<div class="header">
			...
			<div id="heading">
				<a href="index.php" style="color:black";><b>Indian Railways</b></a>
			</div>
			</div>
		</div>
		<!-- Navigation bar -->
...
<footer >
		<div style="width:100%;">
			...
			<p class="text-right text-info">	Desinged By : CREW</p>
			</div>
		</div>
		</footer>
